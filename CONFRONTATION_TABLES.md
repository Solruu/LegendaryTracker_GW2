...
Source : `gw2_sources_v294.json` contre les 77 tables capturées, arête par arête.

- **303 accords** — la table et `qty` disent le même nombre.
...
| `empyreal_star` | `vision_crystal` | 5 | 10 |
| `augurs_stone` | `vision_crystal` | 1 | 2 |

## Arêtes chiffrées par la table et absentes de `qty` — 9
...
| `crystalline_ingot` | `funerary_incense` | 1 |
