...
export default function GW2LegendaryTracker() {
  ...
  const buildDirectProgressionData = useCallback(async (key) => {
    ...
    return { currencies, common, achievements, prismatic, _sub_status: sub, _collections: colls, _direct: true, _bags_ok: bags.ok, stocks: stocksAll, _gates, _recipes: recipesDirect, errors: [] };
  }, []);
