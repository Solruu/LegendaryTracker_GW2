  ...
  vision: {
    ...
    raidAchievements: [
      ...
      { key: "vis_kourna", achievementId: 4760, name: "Visions of Kourna",
        bitTips: {"0": {"fr": "Veste de corsaire : récompense de la maîtrise « Longue vie au Liche ». Choisir un poids déverrouille les trois — inutile de viser le lourd. Sinon, piste de récompense du Domaine de Kourna.", "en": "Corsair Jerkin: reward from the 'Long Live the Lich' mastery. Picking one weight unlocks all three - no need to target heavy. Otherwise, the Domain of Kourna reward track."}, "1": {"fr": "Vision of Dragons: Aurene — près de la Garnison de Zelbahn, le fragment est presque à la verticale de Lady Camilla.", "en": "Vision of Dragons: Aurene - near Zelbahn Garrison, the fragment is almost directly above Lady Camilla."}, "2": {"fr": "Vision of Allies: Blish — interagir avec le listing de données juste à l'ouest de Lady Camilla, au Campement allié.", "en": "Vision of Allies: Blish - interact with the Data Log Printout directly west of Lady Camilla, at the Allied Encampment."}, "3": {"fr": "Vision of Enemies: Olori Ogun — prime légendaire. ⚠ Le Memory Essence Encapsulator doit être EN INVENTAIRE au moment du kill. Il fonctionne depuis un emplacement partagé ou un sac invisible.", "en": "Vision of Enemies: Olori Ogun - legendary bounty. ⚠ The Memory Essence Encapsulator must be IN YOUR INVENTORY at the kill. It works from a shared slot or an invisible bag."}, "4": {"fr": "Vision of Landscapes — faille juste au-dessus de l'Insight « Campement allié », accessible en skyscale. Le rift run doit être terminé, pas seulement atteint.", "en": "Vision of Landscapes - rift right above the 'Allied Encampment' Insight, reached by skyscale. The rift run must be completed, not merely reached."}, "5": {"fr": "Bannière du commandant : ⚠ introuvable au comptoir, à fabriquer. La recette s'achète chez Lady Camilla, au Campement allié, pour 1 po.", "en": "Banner of the Commander: ⚠ not available on the trading post, must be crafted. The recipe is sold by Lady Camilla, at the Allied Encampment, for 1 g."}, "6": {"fr": "Vision of Action — événement « Dansez avec les choyas pour aider les recherches de Tebb ». Événement à horaire, vérifie le timer avant de te déplacer.", "en": "Vision of Action - the 'Dance with the choya to assist Tebb's research' event. Timed event, check the timer before travelling."}},
      ...
      { key: "vis_jahai", achievementId: 4770, name: "Visions of Jahai",
        ...
        bitTips: {
          "Vision of Equipment: Elegy Armor": { fr: "→ collection « The Convergence of Sorrow I: Elegy » ci-dessous, puis parler à Amira.", en: "→ 'The Convergence of Sorrow I: Elegy' collection below, then talk to Amira." },
        },
        tip: { fr: "≈6 étapes : Dragons (Memory Fragment), Allies (interaction), Enemies (boss à vaincre avec un Memory Essence Encapsulator en inventaire), Landscapes (faille au skyscale), Equipment (chaîne de craft — voir le détail sous l'étape) et le skin de l'épisode.", en: "~6 steps: Dragons (Memory Fragment), Allies (interaction), Enemies (map boss, holding a Memory Essence Encapsulator), Landscapes (skyscale rift), Equipment (crafting chain — details under the step) and the episode skin." } },
      { key: "vis_sandswept", achievementId: 4774, name: "Visions of Sandswept Isles",
        ...
        bitTips: {
          "Vision of Dragons: Aurene": { fr: "Au sommet de la falaise directement au nord d'Atholma Waypoint, près d'un arbre.", en: "On top of the cliff directly north of Atholma Waypoint, near a tree." },
          "Vision of Allies: Rox": { fr: "Interagir avec l'Unfinished Field Report, juste en dessous de la vision précédente (près de Jemandi Market).", en: "Interact with the Unfinished Field Report, just below the previous vision (near Jemandi Market)." },
          "Vision of Enemies: Kuda's Subjects": { fr: "Vaincre les sujets de test de Kuda dans la Specimen Chamber, avec un Memory Essence Encapsulator en inventaire.", en: "Defeat Kuda's test subjects in the Specimen Chamber while holding a Memory Essence Encapsulator." },
          "Olmakhan Mantle": { fr: "Récompense des 35 succès « A Bug in the System » (épisode 3 de la LS4).", en: "Reward for the 35 'A Bug in the System' achievements (LWS4 episode 3)." },
        },
        tip: { fr: "≈6 étapes : Dragons (Memory Fragment), Allies (interaction), Enemies (boss à vaincre avec un Memory Essence Encapsulator en inventaire), Landscapes (faille au skyscale), Equipment (chaîne de craft — voir le détail sous l'étape) et le skin de l'épisode.", en: "~6 steps: Dragons (Memory Fragment), Allies (interaction), Enemies (map boss, holding a Memory Essence Encapsulator), Landscapes (skyscale rift), Equipment (crafting chain — details under the step) and the episode skin." } },
      { key: "vis_thunderhead", achievementId: 4764, name: "Visions of Thunderhead Peaks",
        ...
        bitTips: {
          "Vision of Dragons: Aurene": { fr: "Près de The Forge, Thunderhead Peaks.", en: "Near The Forge, Thunderhead Peaks." },
          "Vision of Allies: Caithe": { fr: "Interagir avec la Torn Page juste au sud de History's End Waypoint.", en: "Interact with the Torn Page just south of History's End Waypoint." },
          "Vision of Enemies: Wrathbringer": { fr: "Vaincre Wrathbringer dans Thunderhead Keep avec un Memory Essence Encapsulator en inventaire.", en: "Defeat Wrathbringer in Thunderhead Keep while holding a Memory Essence Encapsulator." },
          "Vision of Landscapes: Thunderhead Peaks": { fr: "Faille au skyscale près des Weeping Sisters : depuis Moorage wp, plein ouest dans la grotte près de Hundar Pike, via le PoI Sorrow's Cave.", en: "Skyscale rift near the Weeping Sisters: from Moorage wp, head far west into the cave near Hundar Pike, through Sorrow's Cave PoI." },
          "Vision of Equipment: Dragonsblood Weapons": { fr: "→ collection « Journeyman of the Forge » ci-dessous (960 Branded Mass, 25 nœuds/jour). ⚠ Ne pas oublier l'achat final à 5 po chez Forge Master Hilina.", en: "→ 'Journeyman of the Forge' collection below (960 Branded Mass, 25 nodes/day). ⚠ Don't forget the final 5 g purchase from Forge Master Hilina." },
        },
        tip: { fr: "≈6 étapes : Dragons (Memory Fragment), Allies (interaction), Enemies (boss à vaincre avec un Memory Essence Encapsulator en inventaire), Landscapes (faille au skyscale), Equipment (chaîne de craft — voir le détail sous l'étape) et le skin de l'épisode.", en: "~6 steps: Dragons (Memory Fragment), Allies (interaction), Enemies (map boss, holding a Memory Essence Encapsulator), Landscapes (skyscale rift), Equipment (crafting chain — details under the step) and the episode skin." } },
      { key: "vis_dragonfall", achievementId: 4757, name: "Visions of Dragonfall",
        ...
        bitTips: {
          "Vision of Dragons: Aurene": { fr: "Au sommet d'un pic rocheux, à l'est de Pact Command wp.", en: "High atop a rock spire, east of Pact Command wp." },
          "Vision of Allies: Zafirah": { fr: "Près du Pact Outpost, Dragonfall.", en: "Near the Pact Outpost, Dragonfall." },
          "Vision of Equipment: Mist Shard Armor": { fr: "Un set complet d'UN SEUL poids — les pièces sont les récompenses de 6 succès « War Eternal » (voir la collection ci-dessous).", en: "A full set of ONE weight class — the pieces are rewards from 6 'War Eternal' achievements (see the collection below)." },
        },
        tip: { fr: "≈6 étapes : Dragons (Memory Fragment), Allies (interaction), Enemies (boss à vaincre avec un Memory Essence Encapsulator en inventaire), Landscapes (faille au skyscale), Equipment (chaîne de craft — voir le détail sous l'étape) et le skin de l'épisode.", en: "~6 steps: Dragons (Memory Fragment), Allies (interaction), Enemies (map boss, holding a Memory Essence Encapsulator), Landscapes (skyscale rift), Equipment (crafting chain — details under the step) and the episode skin." } },
  ...
  coalescence: {
    ...
    raidAchievements: [
      ...
      { key: "coalescence_2", achievementId: 4412, name: "Coalescence II: The Gift",
        bitTips: {"0": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "1": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "2": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "3": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "4": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "5": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "6": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "7": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "8": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "9": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "10": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "11": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "12": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "13": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "14": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "15": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "16": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}, "17": {"fr": "Mécanique unique : achète d'abord l'Appareil à alambic chez Érudite Glenna (100 Éclats de magnétite + 10 po), puis remplis les 18 flacons cachés dans toute la Tyrie. Aucun n'est instancié en raid — c'est du monde ouvert. Interagis avec l'alambic en inventaire une fois les 18 remplis.", "en": "Unique mechanic: first buy the Alembic Apparatus from Scholar Glenna (100 Magnetite Shards + 10 g), then fill the 18 bottles hidden across Tyria. None are inside raid instances - it's all open world. Interact with the Alembic in your inventory once all 18 are filled."}},
      ...
      { key: "coalescence_3", achievementId: 4805, name: "Coalescence III: Culmination",
        bitTips: {"0": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "1": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "2": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "3": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "4": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "5": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "6": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}, "7": {"fr": "Les essences tombent sur les boss de la Clé d'Ahdashim (aile 7 : Cardinale Adina, Cardinal Sabir, Qadim l'Inégalé). Une fois les 3 en poche, va purifier au Sanctuaire des Lanciers du soleil (Domaine de Vabbi) via « Énergie étrange » — c'est la purification qui valide, pas la récolte.", "en": "The essences drop from the Key of Ahdashim bosses (wing 7: Cardinal Adina, Cardinal Sabir, Qadim the Peerless). Once you hold all 3, purify at the Sunspear Sanctuary (Domain of Vabbi) via 'Strange Energy' - it's the purification that validates, not the pickup."}},
  ...
  selachimorpha: {
    ...
    raidAchievements: [
      ...
      { key: "selachi_shipwreck", achievementId: 8880, metaSubs: true, name: "Shipwreck Strand Mastery",
        unlock: { fr: "🔓 Aucune action de déblocage : progression liée aux succès de Shipwreck Strand. 36 requis pour la récompense de maîtrise.", en: "🔓 No unlock step: progress tied to Shipwreck Strand achievements. 36 required for the mastery reward." },
      ...
      { key: "selachi_starlit", achievementId: 9057, metaSubs: true, name: "Starlit Weald Mastery",
        unlock: { fr: "🔓 Aucune action de déblocage : progression liée aux succès de Starlit Weald. 36 requis pour la récompense de maîtrise.", en: "🔓 No unlock step: progress tied to Starlit Weald achievements. 36 required for the mastery reward." },
  ...
  stella_radians: {
    ...
    raidAchievements: [
      { key: "stella_forge_guard", achievementId: 9330, name: "Forge Guard's Armor Collection", total: 6,
        unlock: { fr: "🔓 Rare Collections : s'active en débloquant une première pièce Forge Guard (drop VoE, Alliance Field Quartermaster, ou coffres des méta-succès de carte). 1 pièce débloquée = les 3 poids.", en: "🔓 Rare Collections: activates once you unlock a first Forge Guard piece (VoE drop, Alliance Field Quartermaster, or map meta-achievement chests). 1 piece unlocked = all 3 weights." },
        tip: { fr: "Rare Collections — débloquer les 6 skins Forge Guard (n'importe quel poids : 1 pièce débloquée = les 3 poids). Sources : drops VoE, Alliance Field Quartermaster, boîtes du méta-succès de carte.", en: "Rare Collections — unlock all 6 Forge Guard skins (any weight: 1 piece unlocked = all 3 weights). Sources: VoE drops, Alliance Field Quartermaster, map meta-achievement boxes." } },
      { key: "stella_resin", achievementId: 9344, name: "Glimmering Resin Weapon Collector", total: 17,
        bitTips: {"0": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "1": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "2": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "3": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "4": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "5": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "6": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "7": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "8": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "9": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "10": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "11": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "12": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "13": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "14": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "15": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}, "16": {"fr": "Chaque apparence exige de déverrouiller sa recette PUIS de fabriquer l'arme. Les 17 recettes s'achètent contre des Notes de recherche : c'est le vrai coût de la collection (56 750 au total), pas la fabrication elle-même.", "en": "Each skin requires unlocking its recipe THEN crafting the weapon. All 17 recipes are bought with Research Notes: that's the collection's real cost (56,750 total), not the crafting itself."}},
  ...
  orrax_manifested: {
    ...
    raidAchievements: [
      { key: "orrax_mistburned_mastery", achievementId: 8582, metaSubs: true, name: "Mistburned Barrens Mastery",
        unlock: { fr: "🔓 Aucune action de déblocage : la progression avance dès que tu complètes des succès de Mistburned Barrens (déplier pour la liste). Récompense au palier : Salmon of Knowledge.", en: "🔓 No unlock step: progress advances as you complete Mistburned Barrens achievements (expand for the list). Tier reward: Salmon of Knowledge." },
      ...
      { key: "orrax_bava_mastery", achievementId: 8769, metaSubs: true, name: "Bava Nisos Mastery",
        unlock: { fr: "🔓 Aucune action de déblocage : progression liée aux succès de Bava Nisos (déplier pour la liste). Récompense au palier : Askur Camping Cookout.", en: "🔓 No unlock step: progress tied to Bava Nisos achievements (expand for the list). Tier reward: Askur Camping Cookout." },
  ...
  ad_infinitum: {
    ...
    raidAchievements: [
      { key: "adinf_1", achievementId: 2351,
        bitTips: {"0": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "1": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "2": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "3": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "4": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "5": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "6": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "7": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "8": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "9": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "10": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}}, name: "Ad Infinitum I: Finite Result", total: 11,
      ...
      { key: "adinf_2", achievementId: 2557,
        bitTips: {"0": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "1": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "2": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "3": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "4": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "5": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "6": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "7": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "8": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "9": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "10": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}}, name: "Ad Infinitum II: Upper Bound", total: 11,
      ...
      { key: "adinf_3", achievementId: 2368,
        bitTips: {"0": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "1": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "2": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "3": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "4": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "5": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "6": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "7": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "8": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "9": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}, "10": {"fr": "Chaque journal exige 28 Pages de recherche fractale. À 3/jour de base, c'est ~10 jours par collection ; 9/jour en T4 avec les CM. Les objets tombent dans des fractales précises, à n'importe quelle échelle : ton niveau 30 ne bloque pas la récolte, seulement la cadence des Pages. ⚠ Séquence stricte : fabriquer le précurseur, retourner voir Kelvei, puis double-cliquer — l'ordre inverse ne valide rien.", "en": "Each journal requires 28 Fractal Research Pages. At 3/day baseline that's ~10 days per collection; 9/day at T4 with the CMs. The items drop in specific fractals, at any scale: your level 30 doesn't block the gathering, only the Page cadence. ⚠ Strict sequence: craft the precursor, return to Kelvei, then double-click - the reverse order validates nothing."}}, name: "Ad Infinitum III: Unbound", total: 11,
      ...
      { key: "adinf_4", achievementId: 2295,
        bitTips: {"0": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "1": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "2": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "3": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "4": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "5": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "6": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "7": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "8": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "9": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "10": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "11": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}, "12": {"fr": "Collection finale : elle ne s'ouvre qu'une fois les trois journaux terminés. Les composants sont classiques (dons, matériaux) et achetables — le mur, ce sont les 112 Pages de recherche cumulées en amont, pas cette étape.", "en": "Final collection: it only opens once the three journals are done. The components are standard (gifts, materials) and purchasable - the wall is the 112 Research Pages accumulated upstream, not this step."}}, name: "Legendary Backpack: Ad Infinitum", total: 13,
        ...
        tip: { fr: "13 composants T3/T4 (CM 80% heal réduit : Underground Facility 51+, Aetherblade 51+…). Craftez Unbound puis parlez à Kelvei pour débloquer.", en: "13 T3/T4 components (80% reduced-healing CMs: Underground Facility 51+, Aetherblade 51+…). Craft Unbound then talk to Kelvei to unlock." } },
    ],
    metas: [
