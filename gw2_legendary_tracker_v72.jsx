  ...
  aurora: {
    ...
    raidAchievements: [
      ...
      { key: "henge_3445", achievementId: 3445, name: "Awakening the Druid Stone",
        bitNames: {
          3: { fr: "Wardbough's Rest — remettre à Kodama", en: "Wardbough's Rest — hand to Kodama" },
          6: { fr: "Arboreal Rest — remettre à Kodama", en: "Arboreal Rest — hand to Kodama" },
          9: { fr: "Oakheart's Rest — remettre à Kodama", en: "Oakheart's Rest — hand to Kodama" },
        },
        bitTips: {
          "Element of the Wardbough": { fr: "Greater Wardbough : event d'escorte partant du PoI Scout's Clearing vers le PoI Eternal Pool (Savage Rise).", en: "Greater Wardbough: escort event from Scout's Clearing PoI to Eternal Pool PoI (Savage Rise)." },
          "Element of the Arbor": { fr: "Restless Arboreal Spirit (défi de héros), Hidden Lake — au sud de Seraph Observers wp [&BGIAAAA=], Brisban Wildlands. Lui demander l'objet.", en: "Restless Arboreal Spirit (hero challenge), Hidden Lake — south of Seraph Observers wp [&BGIAAAA=], Brisban Wildlands. Ask him for the item." },
          "Element of the Oakhearts": { fr: "Rotting Ancient Oakheart, event du Greatheart Weald en Queensdale [&BIoGAAA=] — respawn toutes les ~10 min.", en: "Rotting Ancient Oakheart, Greatheart Weald event in Queensdale [&BIoGAAA=] — respawns roughly every 10 min." },
        },
