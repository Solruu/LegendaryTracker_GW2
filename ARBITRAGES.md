...
Source : `gw2_sources_v306.json` — 86 desaccords sur 21 composants.
...
|---|---:|---:|---|
| `airship_part` — Airship Part | 16 | 2000 | deja compte par cascade x16 |
| `ley_line_crystal` — Ley Line Crystal | 16 | 2000 | deja compte par cascade x16 |
| `lump_of_aurillium` — Lump of Aurillium | 16 | 2000 | deja compte par cascade x16 |
...
## DEJA COMPTE PAR CASCADE — 78 cas
...
Les 60 plus gros ecarts sur 78. Le reste se
recalcule en relancant le script.

| composant | legendaire | donnee | wiki | ecart | parents proposes |
|---|---|---:|---:|---:|---|
| `airship_part` — Airship Part | `gen2_the_hms_divinity` | 800 | 2800 | 2000 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_the_hms_divinity` | 800 | 2800 | 2000 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `lump_of_aurillium` — Lump of Aurillium | `gen2_the_hms_divinity` | 800 | 2800 | 2000 | gift_of_gliding (vendeur), gift_of_the_exalted (vendeur), tribute_to_the_man_o_war (vendeur) |
...
| `airship_part` — Airship Part | `gen2_astralaria` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_chuka_and_champawat` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_claw_of_the_khan_ur` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_eureka` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_exordium` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_flames_of_war` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_hope` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_nevermore` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_pharus` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_sharur` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_shooshadoo` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_the_binding_of_ipos` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_the_shining_blade` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_verdarach` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
| `airship_part` — Airship Part | `gen2_xiuquatl` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_itzel (vendeur), tribute_to_the_man_o_war (vendeur) |
...
| `ley_line_crystal` — Ley Line Crystal | `gen2_astralaria` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_chuka_and_champawat` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_claw_of_the_khan_ur` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_eureka` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_exordium` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_flames_of_war` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_hope` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_nevermore` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_pharus` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_sharur` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_shooshadoo` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_the_binding_of_ipos` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_the_shining_blade` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_verdarach` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `ley_line_crystal` — Ley Line Crystal | `gen2_xiuquatl` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_nuhoch (vendeur), tribute_to_the_man_o_war (vendeur) |
| `lump_of_aurillium` — Lump of Aurillium | `gen2_astralaria` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_exalted (vendeur), tribute_to_the_man_o_war (vendeur) |
| `lump_of_aurillium` — Lump of Aurillium | `gen2_chuka_and_champawat` | 800 | 800 | 0 | gift_of_gliding (vendeur), gift_of_the_exalted (vendeur), tribute_to_the_man_o_war (vendeur) |
