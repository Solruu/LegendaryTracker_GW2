...
Source : `gw2_sources_v234.json` — 285 desaccords sur 29 composants.
...
|---|---:|---:|---|
| `glob_of_ectoplasm` — Glob of Ectoplasm | 64 | 3654 | deja compte par cascade x34, alea du trefle mystique x25, cout vendeur x5 |
...
| `obsidian_shard` — Obsidian Shard | 63 | 211 | deja compte par cascade x55, alea du trefle mystique x8 |
...
| `mystic_clover` — Mystic Clover | `gen3_aurenes_voice` | 77 | 38 | 39 | draconic_tribute (recette), gift_of_adventure (vendeur), gift_of_the_side_course (recette) +2 autres |
| `mystic_clover` — Mystic Clover | `gen3_aurenes_weight` | 77 | 38 | 39 | draconic_tribute (recette), gift_of_adventure (vendeur), gift_of_the_side_course (recette) +2 autres |
| `mystic_clover` — Mystic Clover | `gen3_aurenes_wisdom` | 77 | 38 | 39 | draconic_tribute (recette), gift_of_adventure (vendeur), gift_of_the_side_course (recette) +2 autres |
| `mystic_clover` — Mystic Clover | `gen3_aurenes_wrath` | 77 | 38 | 39 | draconic_tribute (recette), gift_of_adventure (vendeur), gift_of_the_side_course (recette) +2 autres |
...
|---|---|---:|---:|---:|---|
| `glob_of_ectoplasm` — Glob of Ectoplasm | `ad_infinitum` | 1039 | 352 | +516 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `endless_summer` | 548 | 10 | +516 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `upgrades` | 1050 | 205 | +389 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_bolt` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_eternity` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_frenzy` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_frostfang` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_howler` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_incinerator` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_kamohoalii_kotaki` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_kraitkin` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_kudzu` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_meteorlogicus` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_quip` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_rodgort` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_sunrise` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_bifrost` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_dreamer` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_flameseeker_prophecies` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_juggernaut` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_minstrel` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_moot` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_the_predator` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `gen1_twilight` | 250 | 327 | -248 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
...
| `obsidian_shard` — Obsidian Shard | `upgrades` | 450 | 205 | -211 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `klobjarne_geirr` | 353 | 88 | +180 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `ad_infinitum` | 339 | 77 | +91 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `conflux` | 309 | 77 | +61 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `the_ascension` | 309 | 77 | +61 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `transcendence` | 309 | 77 | +61 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `warbringer` | 309 | 77 | +61 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `obsidian_shard` — Obsidian Shard | `selachimorpha` | 488 | 305 | +61 | gift_of_castoran_mastery (recette), gift_of_expertise (recette), gift_of_infused_gems (recette) +2 autres |
| `glob_of_ectoplasm` — Glob of Ectoplasm | `eikasia` | 80 | 18 | +22 | amalgamated_rift_essence (recette), gift_of_fortune (recette), gift_of_souls (recette) +6 autres |
