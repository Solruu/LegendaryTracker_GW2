    ...
    raidAchievements: [
      ...
      { key: "vis_kourna", achievementId: 4760, name: "Visions of Kourna",
        bitTips: {
          ...
          "Vision of Landscapes: Domain of Kourna": { fr: "Faille accessible en Skyscale, près du point le plus haut du Campement allié — juste au-dessus du sanctuaire de maîtrise « Allied Encampment ». 💡 Même endroit que le sanctuaire exigé par Vision II : enchaîne les deux en une seule montée.", en: "Rift reachable by Skyscale, near the highest point of the Allied Encampment — right above the 'Allied Encampment' mastery insight. 💡 Same spot as the insight required by Vision II: chain both in one climb." },
          "Banner of the Commander": { fr: "⚠ Le wiki ne donne aucun indice pour cet objet. Non documenté à ce jour — signale-le si tu trouves la source en jeu.", en: "⚠ The wiki gives no hint for this item. Undocumented so far — tell me if you find the source in game." },
          "Vision of Action: Domain of Kourna": { fr: "Terminer le succès « Dance with the choya to assist Tebb's research » (80 danses).", en: "Complete the 'Dance with the choya to assist Tebb's research' achievement (80 dances)." },
        },
