...
| `gw2_meta_pages_v1.py` | **Pages wiki des objectifs de méta** : lit l'ancre `#achievementNNNN` de chaque capture de méta et pose `[id, nom, page]` dans `meta_eligible`. Sans `--ecrire`, mesure seulement | `gw2_sources_vN+1.json` |
