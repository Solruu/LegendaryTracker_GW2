...
| `gw2_relecture_recettes_v2.py` | **Relecture des recettes par légendaire** : descend depuis chaque cible et compare, à chaque nœud, les enfants déclarés à la recette de sa capture. Appariement par apiId. Ne modifie rien | `RELECTURE_RECETTES_vN.md` |
