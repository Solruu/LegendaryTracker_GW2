...
- `gw2_legendary_tracker_v9.jsx` — frontend React (Babel standalone), i18n EN/FR
- `gw2_sources_v5.json` — base de données éditoriale (SOURCES_DB)
...
## Build local
```
python gw2_build_html_v1.py --jsx gw2_legendary_tracker_v9.jsx --out docs/index.html
```
