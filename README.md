...
- `gw2_legendary_tracker_v11.jsx` — frontend React (Babel standalone), i18n EN/FR
...
## Build local
```
python gw2_build_html_v1.py --jsx gw2_legendary_tracker_v11.jsx --out docs/index.html
```
