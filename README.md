...
- `gw2_legendary_tracker_v12.jsx` — frontend React (Babel standalone), i18n EN/FR
- `gw2_sources_v6.json` — base de données éditoriale (SOURCES_DB)
...
## Build local
```
python gw2_build_html_v1.py --jsx gw2_legendary_tracker_v12.jsx --out docs/index.html
```
