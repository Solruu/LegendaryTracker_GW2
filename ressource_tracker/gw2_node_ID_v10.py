...
NODE_TYPES_LIST = [
    ...
    ("rich_somnorite", "Minerai", "Rich Somnorite Vein", False),
    ("somnorite", "Minerai", "Somnorite Ore", False),
    ("rich_vesperite", "Minerai", "Rich Vesperite Vein", False),
    ...
    ("blooming_passiflora", "Vegetal", "Blooming Passiflora", False),
    ("cactus", "Vegetal", "Cactus", True),
    ("clam", "Vegetal", "Clam", False),
    ("cluster_desert_herbs", "Vegetal", "Cluster of Desert Herbs", True),
    ("cluster_herbs", "Vegetal", "Cluster of Herbs", True),
    ...
    ("jungle_plants", "Vegetal", "Jungle Plants", True),
    ...
    ("variegated_taproot", "Vegetal", "Variegated Taproots", True),
    ("taproots", "Vegetal", "Taproots", True),
    ...
    # ── SPECIAL ──────────────────────────────────────────────────────────────────
    ("aurillium", "Special", "Aurillium Node", False),
    ("bloodstone_crystals", "Special", "Bloodstone Crystals", False),
    ("brandstone", "Special", "Brandstone", False),
    ("dragon_crystal", "Special", "Dragon Crystal Node", False),
    ("eternal_ice", "Special", "Eternal Ice", False),
    ("mistborn_mote", "Special", "Mistborn Mote", False),
    ("mistonium", "Special", "Mistonium", False),
    ("petrified_stump", "Special", "Petrified Stump", False),
    ("quartz_formation", "Special", "Quartz Crystal Formation", False),
    ("rich_quartz_formation", "Special", "Rich Quartz Crystal Formation", False),
    ("sprocket_generator", "Special", "Sprocket Generator", False),
    ("winterberry", "Special", "Winterberry Bush", False),
    # -- FESTIVAL (nodes saisonniers, presents uniquement pendant l'evenement) ----
    ("bauble", "Festival", "Bauble", False),
    ("candy_corn", "Festival", "Raw Candy Corn", False),
    ("rich_candy_corn", "Festival", "Rich Candy Corn Vein", False),
]# ---------------------------------------------------------------------------
# MumbleLink
# ---------------------------------------------------------------------------
