...
function TrinketGuide({ curKey, apiAch, gtOwnedIds, gtManualOwnedIds, trinketSteps, toggleStep }) {
  ...
  return (
    <div>
      ...
      {(T.achievements ?? []).length > 0 && !(typeof LEGENDARIES !== "undefined" && LEGENDARIES[curKey]?.raidAchievements) && !T.collections && (
        <>
  ...
  vision: {
    ...
    raidAchievements: [
      ...
      { key: "vis_istan", achievementId: 4765, name: "Visions of Istan",
        bitTips: {
          "Vision of Equipment: Astral Weapons": { fr: "⏳ LE mur de Vision — huit fois la branche Dragonsblood. 6 armes Astral ou Stellar. Prérequis : « Brandstone Research » ci-dessous (timegate 7 j). Par arme : 1 Inscription of the Spearmarshal + 50 Lingots de kralkatite + 2 composants orichalque. Un lingot = 10 Kralkatite Ore + 10 Poudre de quartz rose + 1 ectoplasme, donc 500 + 500 par arme : 3 000 minerais, 3 000 poudres et 300 ectoplasmes pour les 6. 💡 Les 3 vendeurs de cœurs rendent 75 minerais par personnage et par jour, gratuits : c'est le seul levier praticable, et il se démultiplie avec les alts. ⚡ Les skins Astral déjà débloqués comptent, et « Astral Purification » offre de quoi faire une arme Stellar gratuitement : autant d'armes en moins.", en: "⏳ Vision's REAL wall - eight times the Dragonsblood branch. 6 Astral or Stellar weapons. Prerequisite: 'Brandstone Research' below (7-day timegate). Per weapon: 1 Inscription of the Spearmarshal + 50 Kralkatite Ingots + 2 orichalcum components. One ingot = 10 Kralkatite Ore + 10 Powdered Rose Quartz + 1 ectoplasm, so 500 + 500 per weapon: 3,000 ore, 3,000 powder and 300 ectoplasm for all 6. 💡 The 3 heart vendors give 75 ore per character per day, free: the only workable lever, and it scales with alts." },
      ...
      { key: "vis_ep_allornothing", achievementId: 4544, metaSubs: true, name: "« All or Nothing » Mastery",
        tip: { fr: "Sans timegate. ⚠ L'étape « Equipment » ne passe PAS par Journeyman of the Forge : elle demande 6 armes Dragonsblood de six types différents, puis un achat 5 po chez Forge Master Hilina.", en: "No timegate. ⚠ The 'Equipment' step does NOT go through Journeyman of the Forge: it needs 6 Dragonsblood weapons of six different types, then a 5-gold purchase from Forge Master Hilina." } },
      { key: "vis_forge", achievementId: 4577, name: "Journeyman of the Forge (16 armes — facultatif pour Vision)",
        bitTips: {"0": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "1": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "2": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "3": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "4": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "5": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "6": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "7": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "8": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "9": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "10": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "11": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "12": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "13": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "14": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}, "15": {"fr": "⚠ Cette collection en demande 16 — Vision n'en demande que 6, et de SIX TYPES DIFFÉRENTS. Environ 60 Masse marquée par arme, soit ~360 pour Vision, contre ~960 pour finir celle-ci. Plafond : 25 nœuds/jour/compte aux Pics de Chef-Tonnerre.", "en": "⚠ This collection asks for 16 — Vision only needs 6, of SIX DIFFERENT TYPES. Roughly 60 Branded Mass per weapon, so ~360 for Vision against ~960 to finish this one. Cap: 25 nodes per day per account in Thunderhead Peaks."}},
        tip: { fr: "⏳ LE TIMEGATE de Vision I, mais pas par cette collection : Vision demande « Vision of Equipment: Dragonsblood Weapons », soit 6 armes de SIX TYPES DIFFÉRENTS — 6 torches ne comptent pas. ⚠ Après les 6 armes, il faut RETOURNER voir Forge Master Hilina et acheter l'objet 5 po : la collection ne se valide pas toute seule. Les armes Dragonsblood héroïques et le Dragonsblood Impaler ne comptent pas ; un Guaranteed Wardrobe Unlock, si. ~60 Masse marquée par arme → ~360 pour Vision, plafonnées à 25 nœuds/jour/compte (+5/perso/jour au coffre) → ~2 semaines. Cette collection-ci, qui en demande 16, est FACULTATIVE pour Vision.", en: "⏳ THE Vision I timegate, but not through this collection: Vision needs 'Vision of Equipment: Dragonsblood Weapons', i.e. 6 weapons of SIX DIFFERENT TYPES — six torches do not count. ⚠ After the 6 weapons you must GO BACK to Forge Master Hilina and buy the item for 5 gold: the collection does not complete on its own. Heroic Dragonsblood weapons and the Dragonsblood Impaler do not count; a Guaranteed Wardrobe Unlock does. ~60 Branded Mass per weapon → ~360 for Vision, capped at 25 nodes per day per account (+5 per character per day from the chest) → about 2 weeks. This collection, which asks for 16, is OPTIONAL for Vision." } },
...
export default function GW2LegendaryTracker() {
  ...
  // sources font foi ; leg.raidAchievements reste le repli tant que les dix
  // autres legendaires n'ont pas migre. La forme rendue est celle du JSX
  // ({key, achievementId, bitTips, tip}) — les sources s'y coulent.
  ...
  const collList = collMigre.length
    ...
    : (LEGENDARIES[selectedLeg]?.raidAchievements ?? []);
