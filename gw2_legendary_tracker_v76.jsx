  ...
  vision: {
    ...
    raidAchievements: [
      ...
      { key: "vis_istan", achievementId: 4765, name: "Visions of Istan",
        bitTips: {
          "Vision of Equipment: Astral Weapons": { fr: "⚠ CHAÎNE COMPLÈTE (la plus longue de Vision) : 1) succès « Brandstone Research » — TIMEGATÉ 7 JOURS (20 Kralkatite Ore + 15 Powdered Rose Quartz), il débloque Yasna et la recette Kralkatite Ingot. 2) Acheter les recettes d'armes chez Yasna (bas de l'Astralarium), 10 Kralkatite Ore pièce. 3) Crafter 6 armes Astral (Artificer / Huntsman / Weaponsmith) : chacune = 1 Inscription of the Spearmarshal + 50 Kralkatite Ingots + 2 composants orichalque. Les skins Astral déjà débloqués comptent : autant d'armes en moins à crafter. Les armes Stellar comptent aussi.", en: "⚠ FULL CHAIN (Vision's longest): 1) 'Brandstone Research' achievement — 7-DAY TIMEGATE (20 Kralkatite Ore + 15 Powdered Rose Quartz); it unlocks Yasna and the Kralkatite Ingot recipe. 2) Buy the weapon recipes from Yasna (bottom of the Astralarium), 10 Kralkatite Ore each. 3) Craft 6 Astral weapons (Artificer / Huntsman / Weaponsmith): each = 1 Inscription of the Spearmarshal + 50 Kralkatite Ingots + 2 orichalcum components. Already-unlocked Astral skins count: that many fewer to craft. Stellar weapons count too." },
