    ...
    raidAchievements: [
      ...
      { key: "vis_kourna", achievementId: 4760, name: "Visions of Kourna",
        bitTips: {
          ...
          "Banner of the Commander": { fr: "Fabriquer la Bannière du commandant exotique. La recette et une partie des composants s'achètent chez Dame Camilla, au Campement allié [&BFcLAAA=]. Exige Tailleur, Travailleur du cuir ou Armurier niveau 500. ⚠ NE L'ÉQUIPE PAS : elle devient liée à l'âme, et sur un personnage sans l'un de ces trois métiers elle cesse d'être utilisable pour fabriquer sa version élevée, même déposée en banque. Garde-la simplement en inventaire.", en: "Craft the exotic Banner of the Commander. The recipe and some components are sold by Lady Camilla at the Allied Encampment [&BFcLAAA=]. Requires Tailor, Leatherworker or Armorsmith level 500. ⚠ DO NOT EQUIP IT: it becomes soulbound, and on a character without one of those three disciplines it stops being usable to craft its ascended counterpart, even from the bank. Just keep it in your inventory." },
