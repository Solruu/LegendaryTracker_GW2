...
const I18N = {
  en: {
    ...
    up_note1: "One unit = Gift of Runes/Sigils/Relics + Gift of Condensed Magic + Gift of Condensed Might + Gift of Craftsmanship (50 Provisioner Tokens each). Craft 400, recipes 10g from Miyani — or buy the gifts from Lyhr (SotO, +10 Ectos each) / Ward Crafter Lucirae (JW).",
    ...
    tab_collections: "✦ Collections",
    up_note1: "Une unité = Gift of Runes/Sigils/Relics + Gift of Condensed Magic + Gift of Condensed Might + Gift of Craftsmanship (50 Provisioner Tokens chacun). Craft 400, recettes 10 po chez Miyani — ou achat des gifts chez Lyhr (SotO, +10 Ectos pièce) / Ward Crafter Lucirae (JW).",
...
export default function GW2LegendaryTracker() {
  ...
  const tabs = [
    ...
    ...(!isPrismatic && !["conflux", "warbringer", "coalescence", "selachimorpha", "eikasia", "upgrades"].includes(selectedLeg) ? [{ id: "metas", label: `⏱ Metas (${dailyCount})` }] : []),
