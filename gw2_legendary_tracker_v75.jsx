  ...
  vision: {
    ...
    raidAchievements: [
      ...
      { key: "vis_istan", achievementId: 4765, name: "Visions of Istan",
        tip: { fr: "3 étapes : Vision of Dragons (Memory Fragment à trouver), Vision of Allies (interaction PNJ/objet), Vision of Enemies (vaincre le boss de zone en gardant un Memory Essence Encapsulator en inventaire). Fragment au-dessus du PoI Plaza of Resurgence (voler sur la porte puis monter) · Allies = Partially Corrupted Data Entry près de Chalon Docks wp · Enemies = Warden Amala au Mordant Crescent Great Hall.", en: "3 steps: Vision of Dragons (find the Memory Fragment), Vision of Allies (interact with an NPC/object), Vision of Enemies (defeat the map boss while holding a Memory Essence Encapsulator). Fragment above the Plaza of Resurgence PoI (fly onto the gate, then ascend) · Allies = Partially Corrupted Data Entry near Chalon Docks wp · Enemies = Warden Amala at the Mordant Crescent Great Hall." } },
